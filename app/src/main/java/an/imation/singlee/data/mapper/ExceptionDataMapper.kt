...
import java.net.UnknownHostException
 ...
 fun Throwable.toPostExceptionDomainModel(): PostExceptionDomainModel {
    return when {
        this is SocketTimeoutException -> PostExceptionDomainModel.NoInternetConnection(this)
        this is ConnectException -> PostExceptionDomainModel.NoInternetConnection(this)
        this is UnknownHostException -> PostExceptionDomainModel.NoInternetConnection(this)
        ...
        this is PostExceptionDomainModel -> this
